...
| Rubrica | Evidencia |
| --- | --- |
| 1.1 Camada de apresentacao | MVC: [DashboardController.cs linhas 9-132](./MusicStreamer.Api/Controllers/DashboardController.cs#L9-L132), [Index.cshtml linhas 1-371](./MusicStreamer.Api/Views/Dashboard/Index.cshtml#L1-L371), [Login.cshtml linhas 6-31](./MusicStreamer.Api/Views/AccountMvc/Login.cshtml#L6-L31). API: [AuthController.cs linhas 8-27](./MusicStreamer.Api/Controllers/AuthController.cs#L8-L27) |
...
| 4.4 Azure App Service | Aplicacao web preparada para publicacao com Web API + MVC em [Program.cs linhas 69-78](./MusicStreamer.Api/Program.cs#L69-L78) e justificativa em [appsettings.json linhas 10-15](./MusicStreamer.Api/appsettings.json#L10-L15) |
