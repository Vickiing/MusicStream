        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxTransactionAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteBands_UserAccountId_ArtistId",
                table: "FavoriteBands",
                columns: new[] { "UserAccountId", "ArtistId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteMusics_UserAccountId_TrackId",
                table: "FavoriteMusics",
                columns: new[] { "UserAccountId", "TrackId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusicTracks_ArtistId_NormalizedTitle",
                table: "MusicTracks",
                columns: new[] { "ArtistId", "NormalizedTitle" });

            migrationBuilder.CreateIndex(
                name: "IX_MusicTracks_NormalizedTitle",
                table: "MusicTracks",
                column: "NormalizedTitle");

            migrationBuilder.CreateIndex(
                name: "IX_PlaylistTracks_MusicId",
                table: "PlaylistTracks",
                column: "MusicId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaylistTracks_PlaylistId_MusicId",
                table: "PlaylistTracks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserAccountId_RequestedAtUtc",
                table: "Transactions",
                columns: new[] { "UserAccountId", "RequestedAtUtc" });
